...
Greetings
Welcome to the data repository for the Machine Learning course by Abbas Malekpour. The datasets and other supplementary materials are below. Enjoy!
...
Multiple-Linear-Regression.zip
Homework-Solutions.zip
## Section 6. Polynomial Regression
Polynomial-Regression.zip
Regression-Template.zip
